...
if($elve==1)
{
	//$show="增加信息：<select name=\\\"select\\\" onchange=\\\"if(this.options[this.selectedIndex].value!=0){self.location.href='AddNews.php?bclassid=&classid='+this.options[this.selectedIndex].value+'&melve=AddNews';}\\\"><option value='0'>选择增加信息的栏目</option>".$do_class."</select>";
