...
while($r=$Elves->fetch($sql))
{
  ...
  <tr> 
    <td width='96%' rowspan='2'><div align='center'><a href='#Elvescms' title='点击选择' onclick=\"javascript:".$buttonurl."\"><img src='".$file."' width='".$width."' height='".$height."' border=0></a></div></td>
...
<input name="getmark" type="checkbox" id="getmark" value="1">
        ...
        * 高度: 
        ...
        &nbsp;&nbsp;<input type="submit" name="Submit3" value="删除选中" onclick="document.dofile.melve.value='TDelFile_all';"><input type="checkbox" name="chkall" value="on" onclick="CheckAll(this.form)">全选 </td>
    </tr>
  </table>