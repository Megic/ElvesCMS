...
<div align="center">选择</div></td>
  ...
  while($r=$Elves->fetch($sql))
  {
	...
	//播放器
	if(strstr($elve_config['sets']['mediaplayertype'],",".$filetype.","))//mediaplayer
	{
  ...
  <tr> 
    ...
    <td colspan="5" bgcolor="#FFFFFF">&nbsp;&nbsp;
      <?=$returnpage?>
      &nbsp;&nbsp; <input type="submit" name="Submit33" value="删除选中" onclick="document.dofile.melve.value='TDelFile_all';"> 
