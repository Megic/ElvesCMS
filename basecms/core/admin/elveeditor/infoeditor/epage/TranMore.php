...
<body>
<form action="../../elveeditor.php" method="post" enctype="multipart/form-data" target="UploadWindow" name="TranMImgForm" id="TranMImgForm">
<div id="divTranFile"> 
...
<div id="divSetTran" style="display: none"> 
  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
    ...
    <tr bgcolor="#FFFFFF"> 
      <td height="25">水印</td>
      <td><input name="getmark" type="checkbox" id="getmark2" value="1"> <a href="../../../Setmelve.php" target="_blank">加水印</a></td>
    </tr>
  </table>
</div>
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3" class=tableborder>
    ...
    <tr>
      <td height="38"><div align="center">
          ...
          <input type=hidden name=melve value="SaveMoreImg">
