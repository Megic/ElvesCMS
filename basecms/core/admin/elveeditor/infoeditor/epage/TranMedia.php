...
document.write( FCKTools.GetStyleHtml( GetCommonDialogCss() ) ) ;
		...
		function DoCheckTranFile(obj){
			...
			ctypes="<?=$elve_config['sets']['mediaplayertype']?>";
			ctypest="<?=$elve_config['sets']['realplayertype']?>";
...
//返回
function echoViewFile(obj,elve){
	...
	var imgstr="";
	var autostart;
	var mediatypes="<?=$elve_config['sets']['mediaplayertype']?>";
	var realtypes="<?=$elve_config['sets']['realplayertype']?>";
	var furl,filetype;
...
<div id="divUpload" style="DISPLAY: none"> 
  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" id="tranpictb">
    <form id="frmUpload" name="TranFlashFormT" method="post" target="UploadWindow" enctype="multipart/form-data" action="../../elveeditor.php" onsubmit="return DoCheckTranFile(TranFlashFormT);">
