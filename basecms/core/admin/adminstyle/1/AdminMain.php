...
<td height="60">
  ...
  <form name="menuform" id="menuform">
	...
	<input type="hidden" name="onclickmenu" value="">
      <TR> 
            <TD width="180"><div align="center"><a href="main.php" target="main" title="Elves网站管理系统"><img src="adminstyle/1/images/logo.gif" border="0"></a></div></TD>
		<TD height="60"> 
			<TABLE width="760" height="60" border=0 cellpadding="0" cellSpacing=0>
                <TBODY>
                  <TR align=middle> 
                    <TD width=60 onmouseover="if(document.menuform.onclickmenu.value!='dosysmenu'){this.style.backgroundColor='#8CBDEF';}" onmouseout="if(document.menuform.onclickmenu.value!='dosysmenu'){this.style.backgroundColor='';}" onclick="DoOnclickMenu('dosysmenu');JumpToLeftMenu('adminstyle/1/left.php?elve=system');" style="CURSOR: hand" id="dosysmenu"> 
...
<div align="center"><font color="#FFFFFF"><strong>系统</strong></font></div></td>
                    ...
                    <TD width=60 onmouseout="if(document.menuform.onclickmenu.value!='doinfomenu'){this.style.backgroundColor='';}" onmouseover="if(document.menuform.onclickmenu.value!='doinfomenu'){this.style.backgroundColor='#8CBDEF';}" onclick="DoOnclickMenu('doinfomenu');switchSysBarInfo();JumpToLeftMenu('Listmelve.php');" style="CURSOR: hand" id="doinfomenu"> 
                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                        <tr> 
...
<div align="center"><font color="#FFFFFF"><strong>信息</strong></font></div></td>
                    ...
                    <TD width=60 onmouseout="if(document.menuform.onclickmenu.value!='doclassmenu'){this.style.backgroundColor='';}" onmouseover="if(document.menuform.onclickmenu.value!='doclassmenu'){this.style.backgroundColor='#8CBDEF';}" onclick="DoOnclickMenu('doclassmenu');JumpToLeftMenu('adminstyle/1/left.php?elve=classdata');" style="CURSOR: hand" id="doclassmenu"> 
                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                        <tr> 
...
<div align="center"><font color="#FFFFFF"><strong>模板</strong></font></div></td>
                    ...
                    <TD width=60 onmouseout="if(document.menuform.onclickmenu.value!='dousermenu'){this.style.backgroundColor='';}" onmouseover="if(document.menuform.onclickmenu.value!='dousermenu'){this.style.backgroundColor='#8CBDEF';}" onclick="DoOnclickMenu('dousermenu');JumpToLeftMenu('adminstyle/1/left.php?elve=usercp');" style="CURSOR: hand" id="dousermenu"> 
                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                        <tr> 
...
<div align="center"><font color="#FFFFFF"><strong>用户</strong></font></div></td>
                    ...
                    <TD width=60 onmouseout="if(document.menuform.onclickmenu.value!='dotoolmenu'){this.style.backgroundColor='';}" onmouseover="if(document.menuform.onclickmenu.value!='dotoolmenu'){this.style.backgroundColor='#8CBDEF';}" onclick="DoOnclickMenu('dotoolmenu');JumpToLeftMenu('adminstyle/1/left.php?elve=tool');" style="CURSOR: hand" id="dotoolmenu"> 
                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                        <tr> 
...
<div align="center"><font color="#FFFFFF"><strong>商城</strong></font></div></td>
                    ...
                    <TD width=60 onmouseout="if(document.menuform.onclickmenu.value!='doothermenu'){this.style.backgroundColor='';}" onmouseover="if(document.menuform.onclickmenu.value!='doothermenu'){this.style.backgroundColor='#8CBDEF';}" onclick="DoOnclickMenu('doothermenu');JumpToLeftMenu('adminstyle/1/left.php?elve=other');" style="CURSOR: hand" id="doothermenu"><table width="100%" border="0" cellspacing="2" cellpadding="0">
                        <tr> 
...
<div align="center"><font color="#FFFFFF"><strong>扩展</strong></font></div></td>
                    ...
                    <TD width=60 onmouseout="if(document.menuform.onclickmenu.value!='dofastmenu'){this.style.backgroundColor='';}" onmouseover="if(document.menuform.onclickmenu.value!='dofastmenu'){this.style.backgroundColor='#8CBDEF';}" onclick="DoOnclickMenu('dofastmenu');JumpToLeftMenu('adminstyle/1/left.php?elve=fastmenu');" style="CURSOR:hand;<?=$showfastmenu?'':'display:none'?>" id="dofastmenu"><table width="100%" border="0" cellspacing="2" cellpadding="0">
                        <tr> 
...
<div align="center"><font color="#FFFFFF"><strong>常用</strong></font></div></td>
                    ...
                    <TD width="301"><div align="right"><font color="#ffffff">用户：<a href="user/EditPassword.php" target="main"><font color="#ffffff"><b><?=$loginin?></b></font></a>&nbsp;&nbsp;&nbsp;[<a href="#elve" onclick="if(confirm('确认要退出?')){JumpToMain('elveadmin.php?melve=exit');}"><font color="#ffffff">退出</font></a>]&nbsp;&nbsp;</font></div></TD>
                  </TR>
                </TBODY>
              </TABLE>
              ...
              <TABLE class=flyoutMenu border=0>
                <TBODY>
                  <TR align=middle> 
                    ...
                    <TD width="60" class="flyoutLink" onclick="window.open('http://bbs.webelves.org/listthread-23-cms-page-0.html');" onmouseover="over(this)" onmouseout="out(this)">版本更新</TD>
                  </TR>
                </TBODY>
              </TABLE>
            </TD>
