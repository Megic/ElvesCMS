...
//-----------------------------------------修改信息
//索引表
$index_r=$Elves->fetch1("select classid,id,checked from {$dbtbpre}elve_".$class_r[$classid][tbname]."_index where id='$id' limit 1");
...
//副表
$finfor=$Elves->fetch1("select closepl from ".$infodatatb." where id='$id'");
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="tableborder">
  <form name="add" method="post" action="../elveinfo.php">
    <tr class="header"> 
      <td height="25" colspan="2"> 快速修改信息基本属性 
        <input type=hidden value=EditInfoSimple name=melve> <input type=hidden value=<?=$classid?> name=classid> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td><input name="titlepic" type="text" id="titlepic" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[titlepic]))?>" size="45"> 
        <a onclick="window.open('../elveeditor/FileMain.php?type=1&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&doing=1&field=titlepic&sinfo=1','','width=700,height=550,scrollbars=yes');" title="选择已上传的图片"><img src="../../data/images/changeimg.gif" border="0" align="absbottom"></a> 
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
