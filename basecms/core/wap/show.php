...
$r=$Elves->fetch1("select * from {$dbtbpre}elve_".$class_r[$classid]['tbname']." where id='$id' limit 1");
...
//副表
$finfor=$Elves->fetch1("select ".ReturnSqlFtextF($modid)." from {$dbtbpre}elve_".$class_r[$classid]['tbname']."_data_".$r[stb]." where id='$r[id]' limit 1");
