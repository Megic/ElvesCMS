...
</td></tr><tr><td bgcolor=ffffff>软件预览图</td><td bgcolor=ffffff><input name="titlepic" type="text" id="titlepic" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[titlepic]))?>" size="45">
...
</td></tr><tr><td bgcolor=ffffff>软件作者</td><td bgcolor=ffffff><input name="softwriter" type="text" id="softwriter" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[softwriter]))?>" size="60">
</td></tr><tr><td bgcolor=ffffff>厂商主页</td><td bgcolor=ffffff><input name="homepage" type="text" id="homepage" value="<?=$elvefirstpost==1?"http://":ehtmlspecialchars(stripSlashes($r[homepage]))?>" size="60">
</td></tr><tr><td bgcolor=ffffff>系统演示</td><td bgcolor=ffffff><input name="demo" type="text" id="demo" value="<?=$elvefirstpost==1?"http://":ehtmlspecialchars(stripSlashes($r[demo]))?>" size="60">
</td></tr><tr><td bgcolor=ffffff>运行环境</td><td bgcolor=ffffff><input name="softfj" type="text" id="softfj" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[softfj]))?>" size="60">
</td></tr><tr><td bgcolor=ffffff>软件语言</td><td bgcolor=ffffff><select name="language" id="language"><option value="简体中文"<?=$r[language]=="简体中文"?' selected':''?>>简体中文</option><option value="繁体中文"<?=$r[language]=="繁体中文"?' selected':''?>>繁体中文</option><option value="英文"<?=$r[language]=="英文"?' selected':''?>>英文</option><option value="多国语言"<?=$r[language]=="多国语言"?' selected':''?>>多国语言</option></select></td></tr><tr><td bgcolor=ffffff>软件类型</td><td bgcolor=ffffff><select name="softtype" id="softtype"><option value="国产软件"<?=$r[softtype]=="国产软件"?' selected':''?>>国产软件</option><option value="汉化软件"<?=$r[softtype]=="汉化软件"?' selected':''?>>汉化软件</option><option value="国外软件"<?=$r[softtype]=="国外软件"?' selected':''?>>国外软件</option></select></td></tr><tr><td bgcolor=ffffff>授权形式</td><td bgcolor=ffffff><select name="softsq" id="softsq"><option value="共享软件"<?=$r[softsq]=="共享软件"?' selected':''?>>共享软件</option><option value="免费软件"<?=$r[softsq]=="免费软件"?' selected':''?>>免费软件</option><option value="自由软件"<?=$r[softsq]=="自由软件"?' selected':''?>>自由软件</option><option value="试用软件"<?=$r[softsq]=="试用软件"?' selected':''?>>试用软件</option><option value="演示软件"<?=$r[softsq]=="演示软件"?' selected':''?>>演示软件</option><option value="商业软件"<?=$r[softsq]=="商业软件"?' selected':''?>>商业软件</option></select></td></tr><tr><td bgcolor=ffffff>软件评价</td><td bgcolor=ffffff><select name="star" id="star"><option value="1"<?=$r[star]=="1"?' selected':''?>>1星</option><option value="2"<?=$r[star]=="2"||$elvefirstpost==1?' selected':''?>>2星</option><option value="3"<?=$r[star]=="3"?' selected':''?>>3星</option><option value="4"<?=$r[star]=="4"?' selected':''?>>4星</option><option value="5"<?=$r[star]=="5"?' selected':''?>>5星</option></select></td></tr><tr><td bgcolor=ffffff>文件类型</td><td bgcolor=ffffff><input name="filetype" type="text" id="filetype" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[filetype]))?>" size="">
<select name="select2" onchange="document.add.filetype.value=this.value">
        <option value="">类型</option>
        <option value=".zip">.zip</option>
        <option value=".rar">.rar</option>
        <option value=".exe">.exe</option>
      </select></td></tr><tr><td bgcolor=ffffff>文件大小</td><td bgcolor=ffffff><input name="filesize" type="text" id="filesize" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[filesize]))?>" size="">
...
</td></tr><tr><td bgcolor=ffffff>软件简介</td><td bgcolor=ffffff><textarea name="softsay" cols="80" rows="10" id="softsay"><?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[softsay]))?></textarea>
</td></tr>