...
<select name="select" onchange="document.add.filesize.value+=this.value">
  ...
  <tr> 
    ...
    <td bgcolor=ffffff>图片尺寸：<input name="picsize" type="text" id="picsize" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[picsize]))?>" size="">
，图片分辨率：<input name="picfbl" type="text" id="picfbl" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[picfbl]))?>" size="">
</td>
  </tr>
  <tr> 
    <td width=16% height=25 bgcolor=ffffff>来源</td>
    <td bgcolor=ffffff><input name="picfrom" type="text" id="picfrom" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[picfrom]))?>" size="60">
</td>
  </tr>
  <tr> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td bgcolor=ffffff>每行显示条数：<input name="num" type="text" id="num" value="<?=$elvefirstpost==1?"3":ehtmlspecialchars(stripSlashes($r[num]))?>" size="">
，缩图大小：<input name="width" type="text" id="width" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[width]))?>" size="6">
*<input name="height" type="text" id="height" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[height]))?>" size="6">
<font color="#666666">(宽*高)</font></td>
  </tr>
  <tr> 
    <td width=16% height=25 bgcolor=ffffff>图片简介(*)</td>
    <td bgcolor=ffffff><textarea name="picsay" cols="80" rows="10" id="picsay"><?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[picsay]))?></textarea>
</td>
  </tr>
</table>