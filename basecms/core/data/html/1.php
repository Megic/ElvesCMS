...
</table></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>副标题</td><td bgcolor='ffffff'><input name="ftitle" type="text" size=60 id="ftitle" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[ftitle]))?>">
...
</td></tr><tr><td height=25 colspan=2 bgcolor='ffffff'><div align=left>新闻正文(*)</div></td></tr></table><div style="background-color:#D0D0D0"><?=elve_ShowEditorVar("newstext",$elvefirstpost==1?"":stripSlashes($r[newstext]),"Default","","300","100%")?>
