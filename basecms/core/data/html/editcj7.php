...
</td></tr><tr><td bgcolor=ffffff>副标题</td><td bgcolor=ffffff><input name="ftitle" type="text" id="ftitle" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[ftitle]))?>" size="60">
...
</td></tr><tr><td bgcolor=ffffff>标题图片</td><td bgcolor=ffffff><input name="titlepic" type="text" id="titlepic" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[titlepic]))?>" size="45">
...
</td></tr><tr><td bgcolor=ffffff>内容简介</td><td bgcolor=ffffff><textarea name="smalltext" cols="80" rows="10" id="smalltext"><?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[smalltext]))?></textarea>
