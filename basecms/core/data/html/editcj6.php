...
</td></tr><tr><td bgcolor=ffffff>商品编号</td><td bgcolor=ffffff><input name="productno" type="text" id="productno" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[productno]))?>" size="60">
</td></tr><tr><td bgcolor=ffffff>品牌</td><td bgcolor=ffffff><input name="pbrand" type="text" id="pbrand" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[pbrand]))?>" size="60">
</td></tr><tr><td bgcolor=ffffff>简单描述</td><td bgcolor=ffffff><textarea name="intro" cols="80" rows="10" id="intro"><?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[intro]))?></textarea>
</td></tr><tr><td bgcolor=ffffff>计量单位</td><td bgcolor=ffffff><input name="unit" type="text" id="unit" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[unit]))?>" size="60">
</td></tr><tr><td bgcolor=ffffff>单位重量</td><td bgcolor=ffffff><input name="weight" type="text" id="weight" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[weight]))?>" size="60">
