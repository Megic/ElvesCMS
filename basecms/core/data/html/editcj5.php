...
</td></tr><tr><td bgcolor=ffffff>影片格式</td><td bgcolor=ffffff><input name="filetype" type="text" id="filetype" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[filetype]))?>" size="8">
<select name="select2" onchange="document.add.filetype.value=this.value">
      ...
      </select></td></tr><tr><td bgcolor=ffffff>影片大小</td><td bgcolor=ffffff><input name="filesize" type="text" id="filesize" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[filesize]))?>" size="12">
...
</td></tr><tr><td bgcolor=ffffff>影片简介</td><td bgcolor=ffffff><textarea name="moviesay" cols="80" rows="10" id="moviesay"><?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[moviesay]))?></textarea>
</td></tr>