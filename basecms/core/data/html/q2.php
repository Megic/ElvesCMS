...
<input type="file" name="titlepicfile" size="45">
  ...
  <tr> 
    ...
    <td bgcolor=ffffff><input name="softwriter" type="text" id="softwriter" value="<?=$elvefirstpost==1?"":DoReqValue($mid,'softwriter',stripSlashes($r[softwriter]))?>" size="42">
</td>
  </tr>
  <tr> 
    <td width=16% height=25 bgcolor=ffffff>厂商主页</td>
    <td bgcolor=ffffff><input name="homepage" type="text" id="homepage" value="<?=$elvefirstpost==1?"http://":DoReqValue($mid,'homepage',stripSlashes($r[homepage]))?>" size="42">
</td>
  </tr>
  <tr> 
    <td width=16% height=25 bgcolor=ffffff>系统演示</td>
    <td bgcolor=ffffff><input name="demo" type="text" id="demo" value="<?=$elvefirstpost==1?"http://":DoReqValue($mid,'demo',stripSlashes($r[demo]))?>" size="42">
</td>
  </tr>
  <tr> 
    <td width=16% height=25 bgcolor=ffffff>运行环境</td>
    <td bgcolor=ffffff><input name="softfj" type="text" id="softfj" value="<?=$elvefirstpost==1?"":DoReqValue($mid,'softfj',stripSlashes($r[softfj]))?>" size="42">
</td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td bgcolor=ffffff>文件类型：<input name="filetype" type="text" id="filetype" value="<?=$elvefirstpost==1?"":DoReqValue($mid,'filetype',stripSlashes($r[filetype]))?>" size="10">
<select name="select2" onchange="document.add.filetype.value=this.value">
        <option value="">类型</option>
        <option value=".zip">.zip</option>
        <option value=".rar">.rar</option>
        <option value=".exe">.exe</option>
      </select>，文件大小：<input name="filesize" type="text" id="filesize" value="<?=$elvefirstpost==1?"":DoReqValue($mid,'filesize',stripSlashes($r[filesize]))?>" size="10">
...
<input type="file" name="downpathfile" size="45">
  ...
  <tr> 
    ...
    <td bgcolor=ffffff><textarea name="softsay" cols="60" rows="10" id="softsay"><?=$elvefirstpost==1?"":DoReqValue($mid,'softsay',stripSlashes($r[softsay]))?></textarea>
</td>
  </tr>
</table>