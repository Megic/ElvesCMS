...
</td></tr><tr><td bgcolor=ffffff>文件大小</td><td bgcolor=ffffff><input name="filesize" type="text" id="filesize" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[filesize]))?>" size="60">
...
</td></tr><tr><td bgcolor=ffffff>每行显示条数</td><td bgcolor=ffffff><input name="num" type="text" id="num" value="<?=$elvefirstpost==1?"3":ehtmlspecialchars(stripSlashes($r[num]))?>" size="">
</td></tr><tr><td bgcolor=ffffff>缩图宽度</td><td bgcolor=ffffff><input name="width" type="text" id="width" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[width]))?>" size="6">
</td></tr><tr><td bgcolor=ffffff>缩图高度</td><td bgcolor=ffffff><input name="height" type="text" id="height" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[height]))?>" size="6">
</td></tr><tr><td bgcolor=ffffff>图片简介</td><td bgcolor=ffffff><textarea name="picsay" cols="80" rows="10" id="picsay"><?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[picsay]))?></textarea>
</td></tr>