...
</table></td></tr><tr><td bgcolor=ffffff>副标题</td><td bgcolor=ffffff><input name="ftitle" type="text" size=60 id="ftitle" value="<?=$elvefirstpost==1?"":ehtmlspecialchars(stripSlashes($r[ftitle]))?>">
...
</td></tr><tr><td bgcolor=ffffff>新闻正文</td><td bgcolor=ffffff><?=elve_ShowEditorVar("newstext",$elvefirstpost==1?"":stripSlashes($r[newstext]),"Default","","300","100%")?>
