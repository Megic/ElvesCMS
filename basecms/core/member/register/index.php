...
if(!empty($elve_config['member']['changeregisterurl'])&&!$_GET['groupid'])
{
	$changeregisterurl=$elve_config['member']['changeregisterurl'];
	if($tobind)
	{
...
//导入模板
require(elve_PATH.'core/template/member/register.php');
db_close();
$Elves=null;
?>