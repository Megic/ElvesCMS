...
if($sear)
{
	...
	if($formid)
	{
		...
		$formr=$Elves->fetch1("select searchvar from {$dbtbpre}melvememberform where fid='$formid'");
...
$add=" LEFT JOIN {$dbtbpre}melvememberadd ui ON u.".egetmf('userid')."=ui.userid".$add;
$page=(int)$_GET['page'];
...
$tempfile=elve_PATH.'core/template/member/memberlist/'.$tempid.'.php';
if(!file_exists($tempfile))
{
	$tempfile=elve_PATH.'core/template/member/memberlist/1.php';
}
