...
//参数设置
$pagecode=$elve_config['sets']['pagechar']?$elve_config['sets']['pagechar']:'gb2312';
...
function RepSpeRssStr($str){
	...
	$str=str_replace(array('[!--Elvesnews.page--]','[/!--Elvesnews.page--]','[',']'),array('','','',''),$str);
	return $str;
}
...
$query="select ".ReturnSqlListF($mid)." from {$dbtbpre}elve_".$tbname.ReturnYhAndSql($yhadd,$add,1)." order by ".$myorder." ".$myorderby." limit ".$public_r['rssnum'];
