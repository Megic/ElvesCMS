...
//导航菜单
$dhmenu='';
$modsql=$Elves->query("select mid,qmname from {$dbtbpre}melvemod where usemod=0 and showmod=0 and qenter<>'' order by myorder,mid");
...
<title><?=$spacename?> - Powered by ElvesCMS</title>
...
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="F7F7F7">
  <tr>
    ...
    <td align="right"><a href="<?=$public_r[newsurl]?>">网站首页</a> | <a onClick="window.external.addFavorite('<?=$spaceurl?>','<?=$spacename?>')" href="#elve">加入收藏</a> 
      | <a onClick="this.style.behavior='url(#default#homepage)';this.setHomePage('<?=$spaceurl?>')" href="#elve">设为首页</a></td>
 </tr>
</table>
