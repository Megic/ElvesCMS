...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#96C8F1">
  ...
  <tr>
	...
	while($r=$Elves->fetch($sql))
	{
		...
		{
			$ip=' IP: '.$r[ip];
			$adminlink="[<a href='#elve' onclick=\"window.open('../member/mspace/ReGbook.php?gid=$r[gid]','','width=600,height=380,scrollbars=yes');\">回复</a>]&nbsp;&nbsp;[<a href='../member/mspace/?melve=DelMemberGbook&gid=$r[gid]' onclick=\"return confirm('确认要删除?');\">删除</a>]";
		}
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#96C8F1">
  ...
  <tr> 
    <td bgcolor="#FFFFFF">
	  ...
	  <input type="hidden" name="melve" value="AddMemberGbook">
        <tr> 
          <td width="16%">昵称：</td>
            ...
            <td> 
              <table width="160" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="85"><img src="<?=$public_r[newsurl]?>core/ShowKey/?v=spacegb" /></td>
                </tr>
              </table></td>
        </tr>
        <tr> 
