...
$mr=$Elves->fetch1("select tbname,qmname,sonclass from {$dbtbpre}melvemod where mid='$mid'");
...
$page_line=16;
$offset=$page*$line;
$query="select ".ReturnSqlListF($mid)." from {$dbtbpre}elve_".$mr['tbname']." where ".$yhadd.$add." and ismember=1";
$totalquery="select count(*) as total from {$dbtbpre}elve_".$mr['tbname']." where ".$yhadd.$add." and ismember=1";
