...
//原文件,新文件,宽度,高度,维持比例
function ResizeImage($big_image_name, $new_name, $max_width = 400, $max_height = 400, $resize = 1,$new_path){
   if(!file_exists ($new_path)) createDir(dirname($new_name));//判断文件夹是否存在，不存在生成 BY Megic2013-11-28
$returnr['file']='';
$returnr['filetype']='';
