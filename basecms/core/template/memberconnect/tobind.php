...
$regurl=$public_r['newsurl'].'core/member/register/?tobind=1';
$loginurl=$public_r['newsurl'].'core/member/login/?tobind=1';
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="3">
        ...
        <tr>
          <td height="50"><div align="center">
            ...
            <input name="melve" type="hidden" id="melve" value="BindUser">
          </div></td>
          </tr>
        <tr>
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="3">
        ...
        <tr>
          <td height="50"><div align="center">
            ...
            <input name="melve" type="hidden" id="melve" value="BindReg">
          </div></td>
          </tr>
        <tr>
          <td height="25"><div align="center">提示：捆绑成功后，下次
