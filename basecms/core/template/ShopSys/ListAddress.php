...
$url="<a href=../../../>首页</a>&nbsp;>&nbsp;<a href=../../member/cp/>会员中心</a>&nbsp;>&nbsp;配送地址列表&nbsp;&nbsp;(<a href='AddAddress.php?melve=AddAddress'>增加配送地址</a>)";
...
<table width="600" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
  <tr>
    ...
    <td width="50%" bgcolor="#FFFFFF"><div align="right">[<a href="AddAddress.php?melve=AddAddress">增加配送地址</a>]&nbsp;&nbsp;</div></td>
  </tr>
</table>
<br>
<table width="600" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td><div align="center">[<a href="AddAddress.php?melve=EditAddress&addressid=<?=$r['addressid']?>">修改</a>] [<a href="../doaction.php?melve=DefAddress&addressid=<?=$r['addressid']?>" onclick="return confirm('确认要设为默认?');">默认</a>] [<a href="../doaction.php?melve=DelAddress&addressid=<?=$r['addressid']?>" onclick="return confirm('确认要删除?');">删除</a>]</div></td>
    </tr>
    <?php
	}
	?>
