...
?>
<?php
$postword=$melve=='EditAddress'?'修改地址':'增加地址';
  ...
  <form action="../doaction.php" method="post" name="addform" id="addform">
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td height="25"><input type="submit" name="Submit" value="提交">
        ...
        <input name="melve" type="hidden" id="melve" value="<?=$melve?>">      <input name="addressid" type="hidden" id="addressid" value="<?=$addressid?>"></td>
    </tr>
  </form>
</table>
<?php
