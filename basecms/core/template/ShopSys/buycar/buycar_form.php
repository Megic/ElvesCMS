...
<table width='100%' border=0 align=center cellpadding=3 cellspacing=1>
  ...
  <input type=hidden name=melve value=EditBuycar>
    <tr class='header'> 
...
for($i=0;$i<$bcount-1;$i++)
{
	...
	//取得产品信息
	$productr=$Elves->fetch1("select title,tprice,price,isurl,titleurl,classid,id,titlepic,buyfen from {$dbtbpre}elve_".$class_r[$classid][tbname]." where id='$id' limit 1");
...
<tr> 
    <td colspan="7" height="25"><div align="right">
		<a href="../doaction.php?melve=ClearBuycar"><img src="../../data/images/shop/clearbuycar.gif" width=92 height=23 border=0></a>&nbsp;&nbsp;
