...
while($r=$Elves->fetch($sql))
{
	...
	//操作
	$doing='<a href="../doaction.php?melve=DelDd&ddid='.$r[ddid].'" onclick="return confirm(\'确认要取消？\');">取消</a>';
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td> <div align="center"><a href="#elve" onclick="window.open('../ShowDd/?ddid=<?=$r[ddid]?>','','width=700,height=600,scrollbars=yes,resizable=yes');"> 
          <?=$r[ddno]?>
          </a></div></td>
      <td> <div align="center"> 
          <?=$r[ddtime]?>
