          ...
          <tr> 
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="3"<?=$bgcolor?>>
                <tr> 
                  ...
                  <td width="78%">
                    <?=$gbuname?>                  </td>
                  <td width="17%"><div align="center">[<a href="#elve" onclick="window.open('ReGbook.php?gid=<?=$r[gid]?>','','width=600,height=380,scrollbars=yes');">回复</a>]&nbsp;&nbsp;[<a href="index.php?melve=DelMemberGbook&gid=<?=$r[gid]?>" onclick="return confirm('确认要删除?');">删除</a>]</div></td>
                </tr>
                <tr> 
                  <td>&nbsp;</td>
              ...
              <table width="100%" border="0" cellspacing="1" cellpadding="3">
                <tr>
                  ...
                  <td width="95%">
                    ...
                    <input name="melve" type="hidden" id="melve" value="DelMemberGbook_All"> </td>
                </tr>
              </table></td>
          </tr>
		</form>
