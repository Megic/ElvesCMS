...
while($r=$Elves->fetch($sql))
{
	...
	$var="<a title=\"".$r[stylesay]."\"><img src='$r[stylepic]' width=92 height=100 border=0></a><br><span style='line-height=15pt'>".$r[stylename]."</span><br><span style='line-height=15pt'>[<a href='index.php?melve=ChangeSpaceStyle&styleid=".$r[styleid]."'>选定</a>]</span>";
