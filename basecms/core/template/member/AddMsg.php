          ...
          <form action="../../doaction.php" method="post" name="sendmsg" id="sendmsg">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td height="25"><input name="to_username" type="text" id="to_username2" value="<?=$username?>">
                [<a href="#ElvesCMS" onclick="window.open('../../friend/change/?fm=sendmsg&f=to_username','','width=250,height=360');">选择好友</a>] 
                *</td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td height="25"><input type="submit" name="Submit" value="发送">
                &nbsp; 
                <input type="reset" name="Submit2" value="重置"> <input name="melve" type="hidden" id="melve" value="AddMsg">              </td>
            </tr>
          </form>
        </table>
<?php
