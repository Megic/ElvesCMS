...
if(ok)
{
self.location.href='../../doaction.php?melve=DelFriendClass&doing=1&cid='+cid;
}
}
</script>
          ...
          <form name="form1" method="post" action="../../doaction.php">
            ...
            <tr> 
              <td height="25" bgcolor="#FFFFFF">分类名称: 
                ...
                <input name="melve" type="hidden" id="melve" value="AddFriendClass">
          ...
          <form name=form method=post action=../../doaction.php>
            <tr bgcolor="#FFFFFF"> 
              ...
              <td><div align="center">
                  ...
                  <input name="melve" type="hidden" id="melve" value="EditFriendClass">
