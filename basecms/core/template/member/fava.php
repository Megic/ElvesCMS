      ...
      <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
        ...
        <table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableborder">
          <form name=favaform method=post action="../doaction.php" onsubmit="return confirm('确认要操作?');">
            <input type=hidden value=DelFava_All name=melve>
            <tr class="header"> 
            ...
            <?php
			while($fr=$Elves->fetch($sql))
			{
				if(empty($class_r[$fr[classid]][tbname]))
				{continue;}
				$r=$Elves->fetch1("select title,isurl,titleurl,onclick,classid,id from {$dbtbpre}elve_".$class_r[$fr[classid]][tbname]." where id='$fr[id]' limit 1");
				//标题链接
            ...
            <tr bgcolor="#FFFFFF"> 
              <td height="25" colspan="5"> &nbsp;&nbsp;&nbsp; 
                ...
                &nbsp;&nbsp; <select name="cid">
                  ...
                  <?=$select?>
                </select> <input type="submit" name="Submit" value="转移选中" onclick="document.favaform.melve.value='MoveFava_All'"> 
              &nbsp;&nbsp; <input type="submit" name="Submit" value="删除选中" onclick="document.favaform.melve.value='DelFava_All'"></td>
            </tr>
          </form>
        </table>
<?php
