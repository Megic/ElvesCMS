...
if(ok)
{
self.location.href='../../doaction.php?melve=DelFavaClass&cid='+cid;
}
}
</script>
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
          <form name="form1" method="post" action="../../doaction.php">
            ...
            <tr> 
              ...
              <input name="melve" type="hidden" id="melve" value="AddFavaClass"></td>
            </tr>
          </form>
        </table>
        <br>
		...
		?>
          <form name=form method=post action=../../doaction.php>
            <tr bgcolor="#FFFFFF"> 
              ...
              <td><div align="center"> 
                  <input name="melve" type="hidden" id="melve" value="EditFavaClass">
