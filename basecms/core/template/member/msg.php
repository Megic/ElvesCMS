...
$url="<a href=../../../>首页</a>&nbsp;>&nbsp;<a href=../cp/>会员中心</a>&nbsp;>&nbsp;消息列表&nbsp;&nbsp;(<a href='AddMsg/?melve=AddMsg'>发送消息</a>)";
       ...
       e.checked = form.chkall.checked;
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
            <tr>
              ...
              <td width="50%" bgcolor="#FFFFFF"><div align="right">[<a href="AddMsg/?melve=AddMsg">发送消息</a>]&nbsp;&nbsp;</div></td>
            </tr>
        </table>
        <br>
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
          <form name="listmsg" method="post" action="../doaction.php" onsubmit="return confirm('确认要删除?');">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td> <div align="center">&nbsp;[<a href="../doaction.php?melve=DelMsg&mid=<?=$r[mid]?>" onclick="return confirm('确认要删除?');">删除</a>]</div></td>
            </tr>
            <?php
			}
			?>
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="4"><input type="submit" name="Submit2" value="删除选中"> 
                <input name="melve" type="hidden" value="DelMsg_all">              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
