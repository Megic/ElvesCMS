...
if(getcvar('mluserid'))
{
	...
	else
	{
		...
		$useraddr=$Elves->fetch1("select truename,oicq,msn,`mycall`,phone,address,zip from {$dbtbpre}melvememberadd where userid='$user[userid]' limit 1");
	}
}
//导入模板
require(elve_PATH.'core/template/ShopSys/order.php');
db_close();
$Elves=null;
?>